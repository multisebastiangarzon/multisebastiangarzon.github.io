import CasaRock from "../assets/img-projects/CasaRock.png";
import Citarella from "../assets/img-projects/Citarella.png";
import Halcon from "../assets/img-projects/Halcon.png";
import Infinity from "../assets/img-projects/Infinity.png";
import jm from "../assets/img-projects/J&M.png";
import Werock from "../assets/img-projects/WeRock.png";
import Kassa from "../assets/img-projects/Kassa.png";
import PaginaKasa from "../assets/img-projects/PaginaKasa.png";
import PaginaKassa from "../assets/img-projects/PaginaKassa.png";
import SanMiguel from "../assets/img-projects/SanMiguel.png";
import Tirano from "../assets/img-projects/Tirano.png";
import VJ from "../assets/img-projects/VJ.png";

export const proyectos = [
  {
    titulo: "Página Web Citarella",
    descripcion:
      "Desarrollo en Elementor y Wordpress de la página web",
    imagen: Citarella.src,
    tecnologias: ["Illustrator", "Wordpress", "Elementor"],
  ...
  },
  {
    ...
    descripcion:
      "Contenidos con enfoque para Ads",
    imagen: Kassa.src,
  ...
  },
  {
    ...
    descripcion:
      "Pauta en redes apartir de un contenido sólido",
    imagen: Werock.src,
  ...
  },
  {
    ...
    descripcion: "Contenido para festival y artistas musicales.",
    imagen: VJ.src,
  ...
  },
  {
    ...
    descripcion:
      "Página para la promoción de venta.",
    imagen: Halcon.src,
    tecnologias: ["Landing", "IA"],
  ...
  },
  {
    ...
    descripcion:
      "Creación de redes y contenido para Ads.",
